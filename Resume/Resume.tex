    ...
    \begin{minipage}[t]{11cm}
        ...
        \begin{tcolorbox}[grow to right by=0.75cm,colback=white,colframe=white]
            ...
            \begin{itemize}
                \item
                {
                    \textbf{FPT Software - Healthcare Project} \\
                    \emph{Software Engineer (2026-Present)}
                    \begin{itemize}[label=$\circ$]
                        \item {Team's size: 10 - Role: Developer}
                        \item {Develop application and core firmware for a medical endoscope device for a Japan-based customer}
                        \item {Own device security features, including account management, login/logout flow and account database management}
                        \item {Analyze specifications, design PlantUML sequence/class diagrams, implement software and create unit tests}
                        \item {Technical: RSARTE, C++, Eclipse, Git, Linux, Visual Studio}
                    \end{itemize}
                }
                \item 
                {
                    \textbf{FPT - Automotive Embedded Project} \\
                    \emph{Software Engineer (2021-2022)}
                    \begin{itemize}[label=$\circ$]
                        \item {Team's size: 3 - Role: Developer}
                        \item {Deploy \textit{Emergency Call} feature for an in-vehicle telematics control unit on electric vehicle platforms}
...
\begin{tcolorbox}
    ...
    \begin{minipage}[t]{11cm}
        \vspace*{-0.5cm}
        \begin{tcolorbox}[grow to right by=0.75cm,colback=white,colframe=white]
            \section*{Experiences \textnormal{(continued)}}
            \begin{itemize}
                \item 
                {
                    \textbf{Freelancer} \\
